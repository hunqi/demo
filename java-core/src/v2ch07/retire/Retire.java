...
class RetireFrame extends JFrame {
    ...
    private JLabel languangeLabel = new JLabel();
    ...
    public RetireFrame() {
        ...
        add(languangeLabel, new GBC(0, 0).setAnchor(GBC.EAST));
    ...
    /**
     * Updates the information in the text field
     */
    ...
    private void updateDisplay() {
        languangeLabel.setText(resStrings.getString("language"));
...
class RetireComponent extends JComponent {
    ...
    /**
     * Sets the color to be uses before retirement
     *
     * @param colorPre
     */
    ...
    /**
     * Sets the color to be used after retirement while the amount balance is positive
     *
     * @param colorGain
     */
    ...
    /**
     * Sets the color to be used after retirement while the amount balance is negative
     *
     * @return
     */
    ...
    public void paintComponent(Graphics g) {
        ...
        int barWidth = getWidth() / (info.getDeathAge() - info.getCurrentAge());
