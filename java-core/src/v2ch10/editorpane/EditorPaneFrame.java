...
/**
 * This frame contains an editor pane, a text field and button to enter a URL and
 * load a document, and a Back button to return to a previously loaded document.
 */
public class EditorPaneFrame extends JFrame {
    ...
    public EditorPaneFrame() {
        ...
        // put all control components in panel
    ...
    public static void main(String[] args) {
        EventQueue.invokeLater(() -> {
            ...
            frame.setTitle("EditorPaneFrame");
