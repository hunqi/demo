...
/**
 * A frame with a panel that contains several spinners and a button that displays
 * the spinner
 */
public class SpinnerFrame extends JFrame {
    ...
    public SpinnerFrame() {
        ...
        pattern = ((SimpleDateFormat) DateFormat.getDateInstance(DateFormat.SHORT)).toPattern();
