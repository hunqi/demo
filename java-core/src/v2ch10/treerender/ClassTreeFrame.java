...
public class ClassTreeFrame extends JFrame {
    ...
    public ClassTreeFrame() {
        ...
        renderer.setClosedIcon(new ImageIcon(getClass().getResource("/img/redBall.jpg")));
        renderer.setOpenIcon(new ImageIcon(getClass().getResource("/img/yellowBall.jpg")));
        renderer.setLeafIcon(new ImageIcon(getClass().getResource("/img/blueBall.jpg")));
    ...
    private void addTextField() {
        ...
        ActionListener addListener = event -> {
            ...
            try {
                ...
                // clear the text field to indicate success
                textField.setText("");
