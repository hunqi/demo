...
/**
 * Listing 1.5 examples of collecting streams results into maps.
 */
public class CollectingIntoMaps {
    ...
    public static void main(String[] args) {
        ...
        Map<String, String> languageNames = locales.collect(Collectors.toMap(Locale::getDisplayLanguage, Locale::getDisplayLanguage,
