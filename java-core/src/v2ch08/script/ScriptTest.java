...
public class ScriptTest {
    ...
    private static void addListener(String beanName, String eventName, String scriptCode,
                                    ScriptEngine engine, Map<String, Component> components) throws InvocationTargetException, IllegalAccessException, IntrospectionException {
    ...
    private static EventSetDescriptor getEventSetDescriptor(Component bean, String eventName) throws IntrospectionException {
    ...
    private static void getComponentBindings(Component c, Map<String, Component> namedComponents) {
        ...
        if (c instanceof Container)
            for (Component cpt : ((Container) c).getComponents())
                getComponentBindings(cpt, namedComponents);
    }
