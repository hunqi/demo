...
class DOMTreeFrame extends JFrame {
    ...
    private static final int DEFAULT_WIDTH = 666;
    ...
    private void openFile() {
        ...
        Path xmlPath = Paths.get(System.getProperty("user.dir"), "src", "v03", "dom");
        chooser.setCurrentDirectory(xmlPath.toFile());
...
class DOMTreeModel implements TreeModel {
    ...
    public int getChildCount(Object parent) {
        Node nod = (Node) parent;
        return nod.getChildNodes().getLength();
    }
    ...
    private Component elementPanel(Element node) {
        ...
        panel.add(new JTable(new AbstractTableModel() {
            ...
            public Object getValueAt(int rowIndex, int columnIndex) {
                return columnIndex == 0 ? attributes.item(rowIndex).getNodeName() : attributes.item(rowIndex).getNodeValue();
            }
        }));
