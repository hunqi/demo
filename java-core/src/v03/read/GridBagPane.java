...
/**
 * This panel used an XML to describe its components and their gridbag layout positions.
 */
public class GridBagPane extends JPanel {
    ...
    private void parseCell(Element e, int r, int c) {
        ...
        } catch (Exception e1) {  // the reflection method can throw various exception
            e1.printStackTrace();
        }
