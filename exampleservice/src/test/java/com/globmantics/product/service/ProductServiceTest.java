...
public class ProductServiceTest {
    ...
    void testFindByIdSuccess() {
        ...
        Assertions.assertTrue(returnedProduct.isPresent(), "Product was found");
        Assertions.assertSame(returnedProduct.get(), mockProduct, "Product should be the same");
    }
    ...
    void testFindAll() {
        Product mockProduct = new Product(1, "Product Name", 10, 1);
        Product mockProduct2 = new Product(2, "Product Name2", 15, 3);
